...
```
envs:
# 1 keystore pass == key pass
- BITRISEIO_ANDROID_KEYSTORE_1_URL: file:///path/testme
- BITRISEIO_ANDROID_KEYSTORE_PASSWORD_1: pass
- BITRISEIO_ANDROID_KEYSTORE_ALIAS_1: alias
- BITRISEIO_ANDROID_KEYSTORE_PRIVATE_KEY_PASSWORD_1: 
# 2 keystore pass != key pass
- BITRISEIO_ANDROID_KEYSTORE_2_URL: 
- BITRISEIO_ANDROID_KEYSTORE_PASSWORD_2: 
- BITRISEIO_ANDROID_KEYSTORE_ALIAS_2: 
- BITRISEIO_ANDROID_KEYSTORE_PRIVATE_KEY_PASSWORD_2: 
# 3 default alias
- BITRISEIO_ANDROID_KEYSTORE_3_URL: 
- BITRISEIO_ANDROID_KEYSTORE_PASSWORD_3: 
- BITRISEIO_ANDROID_KEYSTORE_ALIAS_3: 
- BITRISEIO_ANDROID_KEYSTORE_PRIVATE_KEY_PASSWORD_3: 
# 4 android studio generated keystore (jks)
- BITRISEIO_ANDROID_KEYSTORE_4_URL: 
- BITRISEIO_ANDROID_KEYSTORE_PASSWORD_4: 
- BITRISEIO_ANDROID_KEYSTORE_ALIA_4: 
